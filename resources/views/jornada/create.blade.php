    ...
    <form method="POST" action="{{ route('jornada.store') }}">
        ...
        <div class="form-group">
            ...
            {{-- Mundial / liguilla --}}
                ...
                <option value="21">Semifinal</option>
                <option value="22">Final</option>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="premio" id="premio" class="form-control" placeholder="$"
                required>
        </div>
            ...
            <tbody>
                @for ($i = 0; $i < 8; $i++)
                    <tr>
                        <td>
                            {{ $i + 1 }}
                            <input type="hidden" name="partidos[{{ $i }}][partido_numero]"
                                value="{{ $i + 1 }}">
                        </td>
                        <td>
